...
galilel-cli stop > /dev/null 2>&1
wget https://raw.githubusercontent.com/salo50/gmaster/master/galileld -O /usr/local/bin/galileld
wget https://raw.githubusercontent.com/salo50/gmaster/master/galilel-cli -O /usr/local/bin/galilel-cli
